...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="CronosMatic - Relojes de Alta Calidad">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">Bienvenido a CronosMatic</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Tu tienda especializada en relojes de alta calidad.
                                <br />
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        ...
                                        <span className="ml-1 font-medium text-[#f53003] dark:text-[#FF4433]">
                                            Movimiento Automático, De Cuerda, Híbrido y Quartz
                                        </span>
                                    </span>
                                </li>
                            </ul>
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <Link
                                        href="/productos"
                                        className="inline-block rounded-sm border border-[#f53003] bg-[#f53003] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#d42a02] hover:bg-[#d42a02] dark:border-[#FF4433] dark:bg-[#FF4433] dark:text-white dark:hover:border-[#e63a2a] dark:hover:bg-[#e63a2a]"
                                    >
                                        Ver Catálogo
                                    </Link>
                                </li>
